...
import com.crestaSom.KTMPublicRoute.Custom.ViewRoutePager;
 ...
 */
public class ViewRouteFragmentNew extends Fragment {
    ...
    ViewRoutePager adapter;


    public ViewRouteFragmentNew() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_view_route_new, container, false);
        routeList=(RecyclerView) view.findViewById(R.id.recyclerView);
        ...
        ar=new ArrayAdapter<String>(getActivity(),
                R.layout.mytextview,routeName);
        //routeList.setAdapter(ar);
        adapter=new ViewRoutePager(getContext(),routes,language);
    ...
    public void updateRouteList(String searchPlace){
        ...
        ar = new ArrayAdapter<String>(getActivity(),
                R.layout.mytextview, routeName);
        adapter.swapData(routeListPlace);
      //  routeList.setAdapter(ar);
